...
void MyGame::render()
{
	...
	GLint ColourLocation = glGetUniformLocation(m_ShaderProgram, "Colour");
	if (ColourLocation != -1)
	{
		vec4 Colours = vec4 (1.0f, 0.0f, 0.0f, 0.0f);
		glUniform4fv(ColourLocation, 1, glm::value_ptr(Colours));
	}
